...
// NETWORK OPTIONS
    ...
    __D(CURLPROTO_TFTP);
#if HAVE_DECL_CURLOPT_REDIR_PROTOCOLS_STR
...
#if HAVE_DECL_CURLE_WEIRD_SERVER_REPLY
...
#if HAVE_DECL_CURLE_QUOTE_ERROR
    D(CURLE_QUOTE_ERROR);
#else
...
#if HAVE_DECL_CURLE_SETOPT_OPTION_SYNTAX
...
#if HAVE_DECL_CURLE_RTSP_SESSION_ERROR
...
#if HAVE_DECL_CURLE_RECURSIVE_API_CALL
    D(CURLE_RECURSIVE_API_CALL);
#else
    ND(CURLE_RECURSIVE_API_CALL);
#endif
#if HAVE_DECL_CURLE_AUTH_ERROR
    D(CURLE_AUTH_ERROR);
#else
    ND(CURLE_AUTH_ERROR);
#endif
#if HAVE_DECL_CURLE_HTTP3
    D(CURLE_HTTP3);
#else
    ND(CURLE_HTTP3);
#endif
#if HAVE_DECL_CURLE_QUIC_CONNECT_ERROR
    D(CURLE_QUIC_CONNECT_ERROR);
#else
    ND(CURLE_QUIC_CONNECT_ERROR);
#endif
#if HAVE_DECL_CURLE_PROXY
    D(CURLE_PROXY);
#else
    ND(CURLE_PROXY);
#endif
#if HAVE_DECL_CURLE_SSL_CLIENTCERT
    D(CURLE_SSL_CLIENTCERT);
#else
    ND(CURLE_SSL_CLIENTCERT);
#endif
#if HAVE_DECL_CURLE_UNRECOVERABLE_POLL
    D(CURLE_UNRECOVERABLE_POLL);
#else
    ND(CURLE_UNRECOVERABLE_POLL);
#endif
#if HAVE_DECL_CURLE_TOO_LARGE
    D(CURLE_TOO_LARGE);
#else
    ND(CURLE_TOO_LARGE);
#endif
#if HAVE_DECL_CURLE_ECH_REQUIRED
