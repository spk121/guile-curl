...
I(CURL_HTTP_VERSION_NONE);
I(CURL_HTTP_VERSION_1_0);
I(CURL_HTTP_VERSION_1_1);
I(CURL_NETRC_OPTIONAL);
I(CURL_NETRC_IGNORED);
I(CURL_NETRC_REQUIRED);
I(CURL_REDIR_POST_301);
I(CURL_REDIR_POST_302);
I(CURL_REDIR_POST_ALL);

I(CURLAUTH_BASIC);
I(CURLAUTH_DIGEST);
I(CURLAUTH_DIGEST_IE);
I(CURLAUTH_GSSNEGOTIATE);
I(CURLAUTH_NTLM);
I(CURLAUTH_ANY);
I(CURLAUTH_ANYSAFE);
I(CURLAUTH_ONLY);
...
I(CURLPROXY_HTTP);
I(CURLPROXY_HTTP_1_0);
I(CURLPROXY_SOCKS4);
I(CURLPROXY_SOCKS5);
I(CURLPROXY_SOCKS4A);
I(CURLPROXY_SOCKS5_HOSTNAME);
